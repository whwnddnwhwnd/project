...
<title>EATS TIME - 나의 식도락 노트</title>
	...
	<section class="container"
		...
		<div class="heading-section ftco-animate mb-3">
			<h2 class="mb-3"
				...
				식도락 노트</h2>
			<!-- 새로운 식도락 노트 등록페이지  이동버튼 -->
			<button type="button" onclick="location.href='/myFoodNoteInsert'"
				class="btn btn-outline-info mt-2"
				style="width: 250px; height: 40px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; letter-spacing: 1px;">
				새로운 식도락 노트 등록</button>
		</div>
	</section>

	<!-- 나의 식도락 노트 표시 -->
	<section class="container"
		style="margin-top: 40px; padding-left: 45px;">
		<div class="container">
			<div class="row">
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<div class="text pt-3 pb-2 px-2">
							<h3 class="heading">
								<label for="noteName" style="color: black;">노트제목</label>
							</h3>
							<h4 class="heading">
								<label for="noteText" style="color: black; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px;">내가 방문한 집 중
									최고. 강릉에 한번 더 놀러갈꺼라면 꼭 가야지~</label>
							</h4>
							<div class="meta">
								<div>
									<label for="noteRegDate">날짜</label>
								</div>
							</div>
							<p class="clearfix">
								<button type="button" onclick="location.href='/myFoodNoteUpdate'"
									class="btn btn-outline-secondary mt-2"
									style="width: 60px; height: 40px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; letter-spacing: 1px;">
									수정</button>
								<button type="button" onclick="location.href='/myFoodNoteDelete'"
