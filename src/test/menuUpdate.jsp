...
<title>EATS TIME - 나의 식도락 노트 수정</title>
...
<body>
	...
	<section class="container"
		...
		<div class="heading-section ftco-animate mb-5">
			<h2 class="mb-4"
				style="font-family: 'Do Hyeon', sans-serif; letter-spacing: 3px; font-weight: 600;">메뉴수정</h2>
		</div>
	</section>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										>메뉴 이름</label> <input type="text"
											class="form-control" placeholder="메뉴이름 불러오기">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										>메뉴 가격</label> <input type="text"
											class="form-control" placeholder="메뉴가격 불러오기">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										...
										>알레르기 유발재료</label> <input
											type="text" class="form-control" placeholder="알레르기 유발재료 불러오기">
									</div>
								</div>
								<div class="col-md-12">
								...
								<div class="col-md-12 mt-3">
									<div class="form-group">
										<input type="submit" value="수정하기"
											class="btn btn-outline-secondary py-3 px-5" id="btn_signup"
