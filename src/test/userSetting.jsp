						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control"
										placeholder="아이디정보 불러오기" readonly="readonly">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="이름정보 불러오기">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="userPwck"
										...
										확인</label> <input type="text" class="form-control" placeholder="">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control"
										placeholder="휴대전화 정보 불러오기">
								</div>
							</div>
							<div class="col-md-6 mt-1">
								<div class="form-group">
									<label for="userGender"
										style="font-family: 'Nanum Gothic', sans-serif; font-size: 17px; font-weight: 600; color: black; letter-spacing: 1px;">성별</label>
							...
							<div class="col-md-6 mt-5">
								<div class="form-group">
									<input type="submit" value="수정하기"
										...
										style="width: 533px; height:54px; font-family: 'Nanum Gothic', sans-serif; font-size: 17px; font-weight: 600; letter-spacing: 1px;">
								</div>
							</div>
						</div>
					</div>
