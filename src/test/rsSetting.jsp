...
<body>
	...
	<!-- section -->
	<!-- 사용자가 가게를 등록하지 않았을 경우 -->
	<!-- 가게설정 타이틀 -->
	<section class="container"
		style="margin-top: 30px; padding-left: 55px; padding-bottom: 20px;">
		<div class="heading-section ftco-animate mb-5">
			<h2 class="mb-4" style="font-family: 'Do Hyeon', sans-serif; letter-spacing: 3px; font-weight: 600;">가게설정</h2>
	<!-- 나의 가게 등록 버튼 -->
		<button type="button" onclick="location.href='/rsInsert'" 
				...
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						...
						<div class="text pt-3 pb-2 px-2">
							<h3 class="heading">
								<label for="rsOwner" style="color: black;">000 님의 가게</label>
							</h3>
							<div class="heading">
								<div>
									<label for="rsName">가게이름</label>
								</div>
							</div>
							<p class="clearfix">
							<button type="button" onclick="location.href='/rsUpdate'" 
							...
							수정</button>
							<button type="button" onclick="location.href='/rsDelete'" 
