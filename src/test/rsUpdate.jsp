...
<body>
	...
	<section>
		<div class="container"
			style="width: 1650px; height: 1610px; padding-left: 20px; border: 1px solid #ddd;">
			<form action="#">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="rsPic"
										...
										사진</label>
									<div>
										<img src="/resources/images/image_1.jpg"
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="rsDesription"
										...
										class="form-control" placeholder="가게 한줄 소개 불러오기">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group form-check">
									...
									<div>
										실내 <input type="checkbox"><br> 실외 <input
											type="checkbox"><br> 불가 <input type="checkbox">
									</div>
								</div>
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group form-check">
									...
									<div>
										좌식공간 <input type="checkbox"><br> 입식공간 <input
											type="checkbox"><br> 야외공간 <input type="checkbox"><br>
										테이크아웃 전문 <input type="checkbox" style="margin-left: 54px;">
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label for="rsLocation"
										style="font-family: 'Nanum Gothic', sans-serif; font-size: 17px; font-weight: 600; color: black; letter-spacing: 1px;">가게
										위치 등록</label> <input type="text"
										style="width: 1100px; height: 50px;" class="form-control"
										placeholder="가게위치 정보 불러오기">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
