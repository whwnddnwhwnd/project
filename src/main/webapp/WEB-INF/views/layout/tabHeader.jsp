...
<link rel="stylesheet" href="/css/css/tab-menu.css">
			...
			<div class="collapse navbar-collapse" id="ftco-nav"
				...
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a href="/restaurant" class="nav-link"
						style="font-size: 20px; letter-spacing: 1px;"> 가게 / 음식점</a></li>
					<li class="nav-item"><a href="/contact" class="nav-link"
						style="font-size: 20px; letter-spacing: 1px;"> Contact</a></li>
					<li class="nav-item"><a href="/mypage" class="nav-link"
						style="font-size: 20px; letter-spacing: 1px;"> 마이페이지</a></li>
					<c:choose>
						<c:when test="${empty principal }">
							<li class="nav-item cta"><a href="/auth/loginForm"
								class="nav-link"
								style="font-size: 20px; letter-spacing: 1px; padding-top: 5px; padding-bottom: 5px; margin-top: 8px;">로그인</a></li>
						</c:when>
						<c:otherwise>
							<li class="nav-item cta"><a href="/logout" class="nav-link"
								style="font-size: 20px; letter-spacing: 1px; padding-top: 5px; padding-bottom: 5px; margin-top: 8px;">Logout</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
